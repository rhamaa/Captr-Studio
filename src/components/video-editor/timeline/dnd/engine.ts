...
export function resolveResizeEnd(
	...
	const { totalMs, minItemDurationMs, allRegionSpans, hasOverlap, snapPoints, snapThresholdMs } =
		config;
	const activeItem = allRegionSpans.find((region) => region.id === activeItemId);
...
export function resolveDragEnd(
	...
	const { allRegionSpans, totalMs, minItemDurationMs, hasOverlap, snapPoints, snapThresholdMs } =
		config;
