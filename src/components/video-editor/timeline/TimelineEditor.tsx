...
export type TimelineEditorProps = RecordSlideTimelineProps & TimelineEditorGlobalProps;
 ...
 */
export const TimelineEditor = React.forwardRef<
...
>(function TimelineEditor(props, ref) {
	...
	const effectiveRecordProps = props.recordProps ?? props;
