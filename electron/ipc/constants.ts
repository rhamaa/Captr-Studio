...
export const PROJECT_FILE_EXTENSION = "captr";
...
export const WHISPER_BASE_MODEL_DOWNLOAD_URL =
	"https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-base.bin";
export const WHISPER_BASE_MODEL_PATH = path.join(WHISPER_MODEL_DIR, "ggml-base.bin");
export const WHISPER_SMALL_MODEL_DOWNLOAD_URL =
	"https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-small.bin";
export const WHISPER_SMALL_MODEL_PATH = path.join(WHISPER_MODEL_DIR, "ggml-small.bin");
export const WHISPER_MODEL_DOWNLOAD_URL = WHISPER_SMALL_MODEL_DOWNLOAD_URL;
